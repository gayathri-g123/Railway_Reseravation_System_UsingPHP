...
$stmt = $conn->prepare("INSERT INTO adminlogoo (firstname, lastname, email, username, pass) VALUES (?, ?, ?, ?, ?)");
...
if ($stmt->execute()) {
    ...
    $conn->close();
        ...
        echo "<script>alert('Signed up Successfully'); window.location.href = 'admin-login.html';</script>";
    exit();
} else {
